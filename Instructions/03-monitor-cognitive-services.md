...
2. **+ 만들기** 드롭다운을 선택하고 **경고 규칙을** 선택합니다.
3. **경고 규칙 만들기** 페이지의 **범위**에서 Cognitive Services 리소스가 나열되어 있는지 확인합니다. (열려 **있는 경우 신호 창 선택** 닫기)
4. **조건** 탭을 선택하고 오른쪽에 표시되는 **신호 선택** 창을 확인합니다. 여기서 모니터링할 신호 유형을 선택할 수 있습니다.
5. **신호 유형** 목록에서 **활동 로그를** 선택한 다음 필터링된 목록에서 **목록 키를** 선택합니다.
